...
const getManifestPath = exports.getManifestPath = bundleName => _path3.default.resolve(_paths.cacheDir, `${bundleName}.manifest.json`);
...
class Plugin {
  ...
  apply(compiler) {
    ...
    const distPath = filename => _path3.default.join(outputPath, filename);
